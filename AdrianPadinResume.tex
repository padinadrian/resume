...
\moveleft.5\hoffset\centerline{44 Windgate Circle, Fishersville, VA 22939}
...
\begin{itemize}
    ...
    \item Served as one of the primary developers for Acalara's next generation
          ...
          Meter data is collected wirelessly with a custom RF protocol and then
    ...
    \item Primary developer for the part of the Base Station firmware which
          implemented the application layer of the custom RF protocol, focused
          on collecting and parsing gas and water meter data.
    \item Developed code primarily in Rust, which I had no prior experience with.
\end{itemize}
